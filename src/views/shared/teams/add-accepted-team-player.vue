...
export default {
  ...
  methods: {
    ...
    async addPlayer() {
      ...
      formData.append("image", this.player.image_file);
      ...
      if (this.$store.getters.role === this.$store.getters.adminRole)
        url = this.$store.getters["main/getURL"] + '/api/admin/add-team-player/' + this.$route.params.id;
      else if (this.$store.getters.role === this.$store.getters.teamRole)
        url = this.$store.getters["main/getURL"] + '/api/team/add-team-player/' + this.$route.params.id;
